...
###
facesOutwardType| Description  
---|---  
| **PropTypes.bool** Set to false if the sphere should face inward. This would
be used if you would want the sphere surrounding the user. Default is true.  
###
heightSegmentCountType| Description  
---|---  
| **PropTypes.number** Controls the number of segments to construct to
approximate the sphere along the Y axis. The higher the number, the higher
resolution the sphere. Default value is 20.  
###
...
---|---  
| **PropTypes.arrayOf(PropTypes.number)** Cartesian position of the sphere in
3D world space, specified as [x, y, z].  
###
radiusType| Description  
---|---  
| **PropTypes.number** The radius of the sphere in 3D space. The default value
is 1.  
###
rotationType| Description  
---|---  
| **PropTypes.arrayOf(PropTypes.number)** The rotation of the sphere around
...
---|---  
| **PropTypes.arrayOf(PropTypes.number)** The scale of the sphere in 3D space,
specified as [x,y,z]. A scale of 1 represents the current size of the sphere.
A scale value of 1 will make the sphere proportionally bigger along the specified axis.  
###
...
|
**PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.string),PropTypes.string])**
An array of transform constraints that affect the transform of the object. For
example, putting the value "billboard" will ensure the sphere is facing the
user as the user rotates their head on any axis. This is useful for icons or
text where you'd like the sphere to always face the user at a particular
rotation.Allowed values(values are case
...
---|---  
| **PropTypes.bool** False if the sphere should be hidden. By default the
sphere is visible and this value is true..  
###
widthSegmentCountType| Description  
---|---  
| **PropTypes.number** Controls the number of segments to construct to
approximate the sphere along the X axis. The higher the number, the higher
resolution the sphere. Default value is 20.  
###
